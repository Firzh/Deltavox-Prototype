...
<section id="dark-section" class="relative w-full h-[100dvh] md:h-[100dvh] lg:h-[140dvh] xl:h-[120dvh] 2xl:h-[140dvh] bg-[#120E0E] flex items-center justify-center overflow-hidden">
    <div class="container mx-auto px-4 mt-30 mb-6 lg:mt-80 xl:-mt-36 grid-cols-1 lg:grid-cols-2 items-center gap-6 md:gap-16 lg:gap-24 relative z-20 py-1">
        ...
        <div class="absolute flex justify-center md:justify-start w-full h-full z-10 2xl:-mt-10 xl:ml-10 2xl:-ml-10 xl:pl-12">
            {{-- Eclipse 1 --}}
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 ml:-8 md:ml-8 lg:ml-16 2xl:ml-8 lg:-mt-140 xl:-mt-40 2xl:-mt-70 pl-4 md:pl-8 xl:pl-12 2xl:pl-4 grid grid-cols-1 md:grid-cols-2 items-center gap-6 md:gap-16 lg:gap-24 relative z-20 py-1 ">
...
<section class="py-20 bg-[#120E0E]">
    <div class="container mx-auto px-4 mt-30 mb-6 lg:mt-80 xl:-mt-10 grid-cols-1 lg:grid-cols-2 items-center gap-6 md:gap-16 lg:gap-24 relative z-20 py-1">

        {{-- Gambar-gambar Ellipse di latar belakang --}}
        {{-- beberapa eclipse ada lebih dari 1 buah dengan opacity berbeda untuk menghasilkan efek vignette lingkaran yang halus daripada basic opacity. Jadi tolong perhatikan itu --}}
        <div class="absolute flex justify-center md:justify-start w-full h-full z-10 2xl:-mt-100 xl:ml-10 2xl:-ml-10 xl:pl-12">
            {{-- Eclipse 1 --}}
            <div class="absolute opacity-26 transform -translate-x-46 md:translate-x-1 lg:translate-x-1 xl:-ml-20 xl:translate-x-1/2 2xl:ml-0 2xl:translate-x-2 md:translate-y-36 lg:-translate-y-94 xl:translate-y-10 2xl:translate-y-150 w-24 scale-300 md:scale-400 lg:scale-460 xl:scale-500 2xl:scale-600">
                <img src="{{ asset('images/14.png') }}" alt="Ellipse 1" class="w-full h-auto object-contain">
            </div>
            
            {{-- Eclipse 2 --}}
            <div class="absolute opacity-13 transform translate-x-20 md:translate-x-70 lg:translate-x-92 xl:translate-x-114 2xl:translate-x-330 translate-y-26 md:translate-y-66 lg:-translate-y-58 xl:translate-y-60 2xl:translate-y-190 w-32 scale-100 md:scale-120 xl:scale-140 2xl:scale-310">
                <img src="{{ asset('images/15.png') }}" alt="Ellipse 2" class="w-full h-auto object-contain">
            </div>

            {{-- Eclipse 3 --}}
            <div class="absolute opacity-50 transform translate-x-20 md:translate-x-70 lg:translate-x-92 xl:translate-x-114 2xl:translate-x-132 translate-y-26 md:translate-y-66 lg:-translate-y-58 xl:translate-y-60 2xl:translate-y-265 w-32 scale-100 md:scale-120 xl:scale-140 2xl:scale-270">
                <img src="{{ asset('images/15.png') }}" alt="Ellipse 2" class="w-full h-auto object-contain">
            </div>
            {{-- opacity 3 - 20 --}}
            <div class="absolute opacity-20 transform translate-x-20 md:translate-x-70 lg:translate-x-92 xl:translate-x-114 2xl:translate-x-132 translate-y-26 md:translate-y-66 lg:-translate-y-58 xl:translate-y-60 2xl:translate-y-265 w-32 sm:scale- md:scale-60 xl:scale-80 2xl:scale-210">
                <img src="{{ asset('images/15.png') }}" alt="Ellipse 2" class="w-full h-auto object-contain">
            </div>

            {{-- Eclipse 4 --}}
            <div class="absolute opacity-50 transform -translate-x-4 md:translate-x-100 lg:translate-x-140 xl:translate-x-160 2xl:translate-x-320 translate-y-60 md:translate-y-18 lg:-translate-y-114 xl:-translate-y-1 2xl:translate-y-406 w-32 scale-160 md:scale-200 xl:scale-220 2xl:scale-500">
                <img src="{{ asset('images/16.png') }}" alt="Ellipse 3" class="w-full h-auto object-contain">
            </div>
            {{-- opacity 4 - 10 --}}
            <div class="absolute opacity-10 transform -translate-x-4 md:translate-x-100 lg:translate-x-140 xl:translate-x-160 2xl:translate-x-320 translate-y-60 md:translate-y-18 lg:-translate-y-114 xl:-translate-y-1 2xl:translate-y-406 w-32 scale-160 md:scale-200 xl:scale-220 2xl:scale-380">
                <img src="{{ asset('images/16.png') }}" alt="Ellipse 3" class="w-full h-auto object-contain">
            </div>

            {{-- Eclipse 5 --}}
            <div class="absolute opacity-30 transform -translate-x-20 md:translate-x-134 lg:translate-x-176 xl:translate-x-208 2xl:translate-x-34 translate-y-125 md:translate-y-70 lg:-translate-y-50 xl:translate-y-80 2xl:translate-y-442 w-24 scale-250 md:scale-300 xl:scale-330">
                <img src="{{ asset('images/17.png') }}" alt="Ellipse 4" class="w-full h-auto object-contain">
            </div>

            {{-- Eclipse 6 --}}
            <div class="absolute opacity-20 transform -translate-x-20 md:translate-x-134 lg:translate-x-176 xl:translate-x-208 2xl:translate-x-130 translate-y-125 md:translate-y-70 lg:-translate-y-50 xl:translate-y-80 2xl:translate-y-524 w-32 scale-250 md:scale-300 xl:scale-440">
                <img src="{{ asset('images/17.png') }}" alt="Ellipse 4" class="w-full h-auto object-contain">
            </div>
        </div>

        {{-- Gambar Pole sebagai elemen latar belakang yang diposisikan absolut --}}
        <div class="absolute inset-0 flex justify-center z-0 mt-30 lg:mt-10 scale-60">
            <img src="{{ asset('images/pole.png') }}" alt="Deltavox Car Activities" class="w-full h-500 object-contain">
        </div>

        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            {{-- Main Column: OUR ACHIEVEMENT --}}
            <div class="text-center animate-fade-in-up-1 hidden-on-load animation-delay-300 ">
                <h2 class="text-6xl md:text-7xl lg:text-[100px] xl:text-[89.11px] custom-font-bebas-neue-regular-1 text-white leading-none tracking-tight ">
                    Our Current <br> Project
                </h2>
            </div>
            
            <div class="grid grid-cols-2 gap-8 lg:gap-36 items-center lg:mt-18">
                <div class="animate-fade-in-left-1 animation-delay-300 hidden-on-load">
                    <img src="{{ asset('images/act-1.png') }}" alt="Deltavox Car Achievement" class="w-full h-auto object-cover">
                </div>
                {{-- Right Column: Award Details --}}
                <div class="text-left animate-fade-in-right-1 animation-delay-300 hidden-on-load">
                    <h3 class="text-xl md:text-3xl custom-font-bebas-neue-1 font-bold text-white mb-4">
                    ...
                    <p class="text-base text-gray-300 custom-font-poppins-regular leading-relaxed">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque saepe assumenda, doloribus perferendis delectus possimus nesciunt vero consequatur in eum dolore debitis vitae voluptatum magnam quia! Aut perferendis quis ipsa! Eaque saepe assumenda, doloribus perferendis delectus possimus nesciunt vero consequatur in eum dolore debitis vitae voluptatum magnam quia!
                    </p>
                </div>
            </div>

            <div class="grid grid-cols-2 gap-8 lg:gap-36 items-center lg:mt-46">
                {{-- Left Column: Award Details --}}
                <div class="text-right animate-fade-in-left-1 animation-delay-300 hidden-on-load">
                    <h3 class="text-xl md:text-3xl custom-font-bebas-neue-1 font-bold text-white mb-4">
                        Lorem ipsum dolor sit amet
                    </h3>
                    <p class="text-base text-gray-300 custom-font-poppins-regular leading-relaxed">
                    ...
                    <br>
                    <p class="text-base text-gray-300 custom-font-poppins-regular leading-relaxed">
                        Eaque saepe assumenda, doloribus perferendis delectus possimus nesciunt vero consequatur in eum dolore debitis vitae voluptatum magnam quia! Aut perferendis quis ipsa! 
                    </p>
                </div>
                <div class="animate-fade-in-right-1 animation-delay-300 hidden-on-load">
                    <img src="{{ asset('images/act-2.png') }}" alt="Deltavox Car Achievement" class="w-full h-auto object-cover">
                </div>
                
            </div>

            <div class="grid grid-cols-2 gap-8 lg:gap-36 items-center lg:mt-40">
                <div class="animate-fade-in-left-1 animation-delay-300 hidden-on-load">
                    <img src="{{ asset('images/act-3.png') }}" alt="Deltavox Car Achievement" class="w-full h-auto object-cover">
                </div>
                {{-- Right Column: Award Details --}}
                <div class="text-left animate-fade-in-right-1 animation-delay-300 hidden-on-load">
                    <h3 class="text-xl md:text-3xl custom-font-bebas-neue-1 font-bold text-white mb-4">
